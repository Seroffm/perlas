...
function homeMarkup() {
  ...
  const specializedServices = [
    { title: 'Baumpflege & Baumfällung', text: 'Eigenständige Fachleistung für Pflege, Rückschnitt und – nach objektbezogener Prüfung – notwendige Fällungen.' },
    { title: 'Tiefgaragenreinigung', text: 'Fahrflächen, Stellplätze und Randbereiche mit abgestimmtem Maschinen- und Handeinsatz.' },
    { title: 'Spielplatzkontrolle & Spielgerätewartung', text: 'Sichtkontrollen, dokumentierte Auffälligkeiten sowie Wartung und Betreuung im vereinbarten Umfang.' },
    { title: 'Büro- & Einrichtungsservice', text: 'Unterstützung bei Möblierung, internen Umstellungen und klar abgegrenzten Arbeiten.' },
  ].map((service) => `<li><strong>${escapeHtml(service.title)}</strong><p>${escapeHtml(service.text)}</p></li>`).join('')
  ...
  return `${staticHeader()}<main class="seo-static-main"><section class="seo-static-hero"><p>Facility Management im Rhein-Main-Gebiet</p><h1>Facility Management für professionell verwaltete Immobilien.</h1><p>Perla’s bündelt Objektbetreuung, technische Koordination, Reinigung, Außenanlagenpflege und Winterdienst. Hausverwaltungen und gewerbliche Auftraggeber erhalten einen festen Ansprechpartner für die laufenden Aufgaben ihrer Immobilien.</p><a href="${basePath}kontakt/">Betreuung anfragen</a></section><section><p>Perla’s Facility Management</p><h2>Facility Management mit persönlicher Verantwortung.</h2><p>Lernen Sie Perla’s, unsere Arbeitsweise und die Menschen hinter der professionellen Betreuung von Wohnanlagen, Gewerbeimmobilien und verwalteten Immobilienbeständen kennen.</p><iframe src="https://www.youtube-nocookie.com/embed/u8PsU3hYVYU?rel=0" title="Perla’s Objektbetreuung – Einblick in das Unternehmen" loading="lazy" allowfullscreen></iframe></section><section><h2>Für diese Immobilien und Auftraggeber arbeiten wir</h2><ul>${partnerNames}</ul></section><section><h2>5,0 Sterne aus 32 Google-Rezensionen</h2><p>Kurze Auszüge aus öffentlich abgegebenen Bewertungen für Perla’s Objektbetreuung.</p><ul class="seo-static-links">${googleReviews}</ul><a href="https://www.google.com/search?q=Perla%27s+Objektbetreuung+GmbH+%26+Co.+KG+Sulzbach+Rezensionen">Alle Rezensionen bei Google ansehen</a></section><section><h2>Der passende Einstieg für Ihr Objekt</h2><ul class="seo-static-links"><li><a href="${basePath}facility-management/">Facility Management</a><p>Mehrere Aufgaben in einem abgestimmten Betreuungskonzept.</p></li><li><a href="${basePath}leistungen/">Leistungen</a><p>Einzelleistungen für den laufenden Immobilienbetrieb.</p></li><li><a href="${basePath}ueber-uns/">Über uns</a><p>Perla’s Objektbetreuung seit 1999.</p></li><li><a href="${basePath}kontakt/">Kontakt</a><p>Ihr Objekt persönlich besprechen.</p></li></ul></section><section><h2>Das übernehmen wir für Ihre Immobilie</h2><p>Sechs Leistungen, die sich einzeln beauftragen oder im Facility Management sinnvoll verbinden lassen.</p><ul class="seo-static-links">${coreServices}</ul><a href="${basePath}leistungen/">Alle Leistungen ansehen</a></section><section><p>Facility Management → regelmäßige Kernleistungen → ergänzende Fachleistungen</p><h2>Ergänzende Fachleistungen für professionell betreute Immobilien.</h2><p>Umfang, Zuständigkeit und erforderliche Fachkunde werden je Leistung vor der Beauftragung geklärt.</p><ul class="seo-static-links">${specializedServices}</ul><a href="${basePath}kontakt/">Spezialleistung anfragen</a></section><section><h2>Einsatzbereit im Rhein-Main-Gebiet</h2><p>10+ Mitarbeitende, abgestimmte Touren und ein wachsender Fuhrpark unterstützen die verlässliche Betreuung größerer Immobilien.</p><img src="${basePath}assets/kundenbilder/fahrzeuge/perlas_fuhrpark_ki.png" alt="Visualisierung eines größeren Perla’s-Fuhrparks"></section><section><h2>Betreuung nach Objektart</h2><ul class="seo-static-links">${audienceLinks}</ul><a href="${basePath}facility-management/">Alle Objektbereiche ansehen</a></section><section><h2>Erfahrung und klare Abläufe</h2><p>Perla’s schafft Übersicht über wiederkehrende Aufgaben und hält Rückmeldungen zu Zustand, Leistung und Handlungsbedarf an einer Stelle zusammen.</p></section></main>`
}
...
function servicesMarkup() {
  ...
  const specialized = [
    { title: 'Baumpflege & Baumfällung', text: 'Pflege, Rückschnitt und – nach objektbezogener Prüfung – notwendige Fällungen.' },
    { title: 'Tiefgaragenreinigung', text: 'Fahrflächen, Stellplätze und Randbereiche mit abgestimmtem Maschinen- und Handeinsatz.' },
    { title: 'Spielplatzkontrolle & Spielgerätewartung', text: 'Regelmäßige Sichtkontrollen, dokumentierte Auffälligkeiten und koordinierte Maßnahmen.' },
    { title: 'Büro- & Einrichtungsservice', text: 'Unterstützung bei Möblierung, internen Umstellungen und klar abgegrenzten Arbeiten.' },
  ].map((service) => `<li><strong>${escapeHtml(service.title)}</strong><p>${escapeHtml(service.text)}</p></li>`).join('')
